...
def nlp_review_func():
    try:
        df_cust = p.read_csv(r'./Original_Data/olist_customers_dataset.csv')
        df_loc = p.read_csv(r'./Original_Data/olist_geolocation_dataset.csv')
        df_items = p.read_csv(r'./Original_Data/olist_order_items_dataset.csv')
        df_pmt = pd.read_csv(r'./Original_Data/olist_order_payments_dataset.csv')
        df_rvw = pd.read_csv(r'./Original_Data/olist_order_reviews_dataset.csv')
        df_products = pd.read_csv(r'./Original_Data/olist_products_dataset.csv')
        df_orders = pd.read_csv(r'./Original_Data/olist_orders_dataset.csv')
        df_sellers = pd.read_csv(r'./Original_Data/olist_sellers_dataset.csv')
        df_cat_name = pd.read_csv(r'./Original_Data/product_category_name_translation.csv')
    ...
    logging.info(important_trigrams)
    ...
    #
    #
    et_ipython().system(u'pip install mysql-connector-python')
    #
    # # In[50]:
    #
    #
