...
# load the data
customer = pd.read_csv(r'./Original_Data/olist_customers_dataset.csv')
order = pd.read_csv(r'./Original_Data/olist_orders_dataset.csv')
item = pd.read_csv(r'./Original_Data/olist_order_items_dataset.csv')
payment = pd.read_csv(r'./Original_Data/olist_order_payments_dataset.csv')
